...
public class Apicurious
{
  ...
  {
    event.registerSpecial(ParticleTypeRegistrar.BEE.get(), (beeParticleOption, clientLevel, x, y, z, xd, yd, zd, randomSource) -> new BeeParticle.Provider().createParticle(beeParticleOption, clientLevel, x, y, z, xd, yd, zd, randomSource));
  }
