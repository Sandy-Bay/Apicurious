...
public class ApicuriousLootTables extends LootTableProvider
{
  ...
  public static class ApicuriousBlockLoot extends BlockLootSubProvider
  {
    ...
    {
      return LootTable.lootTable().setParamSet(LootContextParamSets.BLOCK).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(LootItem.lootTableItem(ItemRegistrar.PRINCESS.item().get()).apply(ApicuriousSpeciesFunction.getBuilder(speciesKey)).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(provider.lookupOrThrow(Registries.ITEM), ApicuriousTags.ItemTags.IS_SIEVE_TOOL))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(LootItem.lootTableItem(ItemRegistrar.DRONE.item().get()).apply(ApicuriousSpeciesFunction.getBuilder(speciesKey)).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(provider.lookupOrThrow(Registries.ITEM), ApicuriousTags.ItemTags.IS_SIEVE_TOOL))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(LootItem.lootTableItem(ItemRegistrar.DRONE.item().get()).apply(ApicuriousSpeciesFunction.getBuilder(speciesKey)).when(LootItemRandomChanceCondition.randomChance(0.5f)).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(provider.lookupOrThrow(Registries.ITEM), ApicuriousTags.ItemTags.IS_SIEVE_TOOL))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(LootItem.lootTableItem(ItemRegistrar.DRONE.item().get()).apply(ApicuriousSpeciesFunction.getBuilder(speciesKey)).when(LootItemRandomChanceCondition.randomChance(0.333f)).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(provider.lookupOrThrow(Registries.ITEM), ApicuriousTags.ItemTags.IS_SIEVE_TOOL))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(LootItem.lootTableItem(ItemRegistrar.DRONE.item().get()).apply(ApicuriousSpeciesFunction.getBuilder(ApicuriousSpecies.VALIANT.species())).when(LootItemRandomChanceCondition.randomChance(0.05f)).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(provider.lookupOrThrow(Registries.ITEM), ApicuriousTags.ItemTags.IS_SIEVE_TOOL)))));
    }
