...
public class ApicuriousModelProvider extends ModelProvider
{
  ...
  private static void generateBees(ItemModelGenerators itemModels)
  {
    ...
    itemModels.itemModelOutput.register(Apicurious.createIdentifier("species/default_drone"), new ClientItem(new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/species/default_bee"), Optional.empty(), List.of(
            new BeeItemTinter(true, false), new BeeItemTinter(false, true),
            new BeeItemTinter(false, false), new BeeItemTinter(false, false), new BeeItemTinter(false, false)
    )), ClientItem.Properties.DEFAULT));
    itemModels.itemModelOutput.register(Apicurious.createIdentifier("species/default_princess"), new ClientItem(new CompositeModel.Unbaked(
            List.of(
                    new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/species/default_bee"), Optional.empty(), List.of(
                            new BeeItemTinter(true, false), new BeeItemTinter(false, true),
                            new BeeItemTinter(false, false), new BeeItemTinter(false, false), new BeeItemTinter(false, false)
                    )),
                    new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/species/princess_crown"), Optional.empty(), List.of())
            ),
            Optional.empty()
    ), ClientItem.Properties.DEFAULT));
    itemModels.itemModelOutput.register(Apicurious.createIdentifier("species/default_queen"), new ClientItem(new CompositeModel.Unbaked(
            List.of(
                    new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/species/default_bee"), Optional.empty(), List.of(
                            new BeeItemTinter(true, false), new BeeItemTinter(false, true),
                            new BeeItemTinter(false, false), new BeeItemTinter(false, false), new BeeItemTinter(false, false)
                    )),
                    new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/species/queen_crown"), Optional.empty(), List.of())
            ),
            Optional.empty()
    ), ClientItem.Properties.DEFAULT));
    // Models > Item
  ...
  private static void generateDrops(ItemModelGenerators itemModels)
  {
    ...
    ItemRegistrar.DROPS_LIST.forEach(holder -> {
      itemModels.itemModelOutput.accept(holder.get(), new CompositeModel.Unbaked(
              List.of(
                      new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/drop"), Optional.empty(), List.of(new DropItemTinter(false))),
                      new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/drop_highlight"), Optional.empty(), List.of(new DropItemTinter(true)))
              ),
              Optional.empty()
      ));
    });
  ...
  private static void generateCombs(ItemModelGenerators itemModels)
  {
    ...
    ItemRegistrar.COMBS_LIST.forEach(holder -> {
      itemModels.itemModelOutput.accept(holder.get(), new CompositeModel.Unbaked(List.of(
              new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/comb_outline"), Optional.empty(), List.of(new CombItemTinter(true))),
              new CuboidItemModelWrapper.Unbaked(Apicurious.createIdentifier("item/comb_cells"), Optional.empty(), List.of(new CombItemTinter(false)))
      ), Optional.empty()));
    });
  }
    ...
    BlockRegistrar.HIVES.forEach(holder -> {
      ...
      blockModels.blockStateOutput.accept(
              MultiVariantGenerator
                      .dispatch(holder.asBlock(), BlockModelGenerators.variant(hive))
  ...
  private static void generateMachines(BlockModelGenerators blockModels, ItemModelGenerators itemModels)
  {
    // Apiary
    blockModels.blockStateOutput.accept(
            MultiVariantGenerator.dispatch(BlockRegistrar.APIARY.asBlock())
                    .with(BlockModelGenerators.createBooleanModelDispatch(BaseHousingBlock.ACTIVE,
                            BlockModelGenerators.variant(new Variant(Apicurious.createIdentifier("block/apiary_active"))),
                            BlockModelGenerators.variant(new Variant(Apicurious.createIdentifier("block/apiary")))
                    ))
    );
    ...
    // Bee Housing
    blockModels.blockStateOutput.accept(
            MultiVariantGenerator.dispatch(BlockRegistrar.BEE_HOUSING.asBlock())
                    .with(BlockModelGenerators.createBooleanModelDispatch(BaseHousingBlock.ACTIVE,
                            BlockModelGenerators.variant(new Variant(Apicurious.createIdentifier("block/bee_housing_active"))),
                            BlockModelGenerators.variant(new Variant(Apicurious.createIdentifier("block/bee_housing")))
                    ))
    );
