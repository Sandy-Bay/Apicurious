...
public class ApicuriousLangProvider extends LanguageProvider
{
  ...
  protected void addTranslations()
  {
    ...
    add(ItemRegistrar.HONEY_DROP.item().get(), "Honey Drop");
    add(ItemRegistrar.HONEY_DEW.item().get(), "Honey Dew");
    add(ItemRegistrar.ROYAL_JELLY.item().get(), "Royal Jelly");
    add(ItemRegistrar.PROPOLIS.item().get(), "Propolis");
    add(ItemRegistrar.SILKEN_PROPOLIS.item().get(), "Silken Propolis");
    add(ItemRegistrar.SILK_WISP.item().get(), "Silk Wisp");
    add(ItemRegistrar.POLLEN.item().get(), "Pollen");
    ...
    add(ItemRegistrar.WATERY_PROPOLIS.item().get(), "Watery Propolis");
    add(ItemRegistrar.RED_TINTED_DROP.item().get(), "Red-Tinted Drop");
    add(ItemRegistrar.YELLOW_TINTED_DROP.item().get(), "Yellow-Tinted Drop");
    add(ItemRegistrar.BLUE_TINTED_DROP.item().get(), "Blue-Tinted Drop");
    add(ItemRegistrar.GREEN_TINTED_DROP.item().get(), "Green-Tinted Drop");
    add(ItemRegistrar.BROWN_TINTED_DROP.item().get(), "Brown-Tinted Drop");
    add(ItemRegistrar.WHITE_TINTED_DROP.item().get(), "White-Tinted Drop");
    add(ItemRegistrar.BLACK_TINTED_DROP.item().get(), "Black-Tinted Drop");
    add(ItemRegistrar.ORANGE_TINTED_DROP.item().get(), "Orange-Tinted Drop");
    add(ItemRegistrar.CYAN_TINTED_DROP.item().get(), "Cyan-Tinted Drop");
    add(ItemRegistrar.PURPLE_TINTED_DROP.item().get(), "Purple-Tinted Drop");
    add(ItemRegistrar.GRAY_TINTED_DROP.item().get(), "Gray-Tinted Drop");
    add(ItemRegistrar.LIGHT_BLUE_TINTED_DROP.item().get(), "Light Blue-Tinted Drop");
    add(ItemRegistrar.PINK_TINTED_DROP.item().get(), "Pink-Tinted Drop");
    add(ItemRegistrar.LIME_TINTED_DROP.item().get(), "Lime-Tinted Drop");
    add(ItemRegistrar.LIGHT_GRAY_TINTED_DROP.item().get(), "Light Gray-Tinted Drop");
    add(ItemRegistrar.MAGENTA_TINTED_DROP.item().get(), "Magenta-Tinted Drop");
    add(ItemRegistrar.SALTPETER.item().get(), "Saltpeter");
    add(ItemRegistrar.ACIDIC_DROP.item().get(), "Acidic Drop");
