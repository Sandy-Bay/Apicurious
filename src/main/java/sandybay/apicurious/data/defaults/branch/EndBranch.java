...
public class EndBranch
{
  public static void speciesDefaults(BootstrapContext<IAllele<?>> bootstrap)
  {
    bootstrap.register(ApicuriousSpecies.ENDER.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.ENDER.species(), "ender")
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.COLD)
    ...
    bootstrap.register(ApicuriousSpecies.SPECTRAL.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.SPECTRAL.species(), "spectral")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.SPECTRAL))
                    .withProductionData(builder -> builder
                            .withArea(Area.LARGE)
                            .withFertility(Fertility.LOW_FERTILITY)
                            .withLifespan(Lifespan.LONGER)
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.COLD)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.SPECTRAL.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.PHANTASMAL.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.PHANTASMAL.species(), "phantasmal")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.PHANTASMAL))
                    .withProductionData(builder -> builder
                            .withArea(Area.LARGE)
                            .withFertility(Fertility.LOW_FERTILITY)
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.COLD)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.PHANTASMAL.output()))
                    .build()
    );
  }
  ...
  {
    bootstrap.register(ApicuriousSpecies.SPECTRAL.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.ENDER.species())
                    .withSecond(ApicuriousSpecies.HERMITIC.species())
                    .withChance(0.04f)
                    .withOutput(ApicuriousSpecies.SPECTRAL.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.PHANTASMAL.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.ENDER.species())
                    .withSecond(ApicuriousSpecies.SPECTRAL.species())
                    .withChance(0.02f)
                    .withOutput(ApicuriousSpecies.PHANTASMAL.species())
                    .build()
    );
  }
