...
public class BarrenBranch
{
  ...
  {
    bootstrap.register(ApicuriousSpecies.ARID.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.MEADOW.species())
                    .withSecond(ApicuriousSpecies.FRUGAL.species())
                    .withChance(0.1f)
                    .withOutput(ApicuriousSpecies.ARID.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.BARREN.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.ARID.species())
                    .withSecond(ApicuriousSpecies.COMMON.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.BARREN.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.DESOLATE.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.ARID.species())
                    .withSecond(ApicuriousSpecies.BARREN.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.DESOLATE.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.GNAWING.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.FOREST.species())
                    .withSecond(ApicuriousSpecies.BARREN.species())
                    .withChance(0.15f)
                    .withOutput(ApicuriousSpecies.GNAWING.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.DECOMPOSING.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.BARREN.species())
                    .withSecond(ApicuriousSpecies.MARSHY.species())
                    .withChance(0.15f)
                    .withOutput(ApicuriousSpecies.DECOMPOSING.species())
                    .build()
    );
  }
  ...
  public static void outputsDefaults(BootstrapContext<OutputTable> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.GNAWING.output(), OutputTableDefaults.custom()
            ...
            .withPool(pool -> pool
                    ...
                    .withResult(result -> result.withResult(ItemRegistrar.DECOMPOSED_COMB.get()))
            )
            .build()
    );
  }
