...
public class FestiveBranch
{
  public static void speciesDefaults(BootstrapContext<IAllele<?>> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.TIPSY.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.TIPSY.species(), "tipsy")
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOW_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.TIPSY.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.CELEBRATORY.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.CELEBRATORY.species(), "celebratory")
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOW_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.CELEBRATORY.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.TRICKY.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.TRICKY.species(), "tricky")
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOW_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.TRICKY.output()))
                    .build()
    );
  }
  ...
  public static void mutationsDefaults(BootstrapContext<IMutation> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.TIPSY.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.MEADOW.species())
                    .withSecond(ApicuriousSpecies.WINTRY.species())
                    .withChance(0.1f)
                    .withCondition(ConditionKeys.IS_NEW_YEARS)
                    .withOutput(ApicuriousSpecies.TIPSY.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.CELEBRATORY.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.AUSTERE.species())
                    .withSecond(ApicuriousSpecies.EXCITED.species())
                    .withChance(0.05f)
                    .withOutput(ApicuriousSpecies.CELEBRATORY.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.TRICKY.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.SINISTER.species())
                    .withSecond(ApicuriousSpecies.COMMON.species())
                    .withChance(0.1f)
                    .withCondition(ConditionKeys.IS_HALLOWEEN)
                    .withOutput(ApicuriousSpecies.TRICKY.species())
                    .build()
    );
  }
  ...
  public static void outputsDefaults(BootstrapContext<OutputTable> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.TIPSY.output(), OutputTableDefaults.custom()
            .withPool(pool -> pool
                    .when(new ChanceCondition(0.3f))
                    .withResult(result -> result.withResult(ItemRegistrar.FROZEN_COMB.get()))
            )
    ...
    bootstrap.register(ApicuriousSpecies.TRICKY.output(), OutputTableDefaults.custom()
            ...
            .withPool(pool -> pool
                    ...
                    .withResult(result -> result.withResult(Items.COOKIE))
            )
            .withPool(pool -> pool
                    .withResult(result -> {
