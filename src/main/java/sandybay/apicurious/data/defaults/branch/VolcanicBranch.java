...
public class VolcanicBranch
{
  public static void speciesDefaults(BootstrapContext<IAllele<?>> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.FURIOUS.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.FURIOUS.species(), "furious")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.FURIOUS))
                    .withProductionData(builder -> builder
                            .withSpeed(Speed.SLOWER)
                            .withWorkCycle(Workcycle.ALWAYS))
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.HELLISH)
                            .withTemperatureTolerance(TemperatureTolerance.LOW_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.FURIOUS.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.VOLCANIC.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.VOLCANIC.species(), "volcanic")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.VOLCANIC).hasEffect())
                    .withProductionData(builder -> builder
                            .withSpeed(Speed.SLOWER)
                            .withWorkCycle(Workcycle.ALWAYS))
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.HELLISH)
                            .withTemperatureTolerance(TemperatureTolerance.LOW_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.VOLCANIC.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.GLOWERING.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.GLOWERING.species(), "glowering")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.GLOWERING))
                    .withProductionData(builder -> builder
                            .withSpeed(Speed.SLOWER)
                            .withWorkCycle(Workcycle.ALWAYS))
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.HELLISH)
                            .withTemperatureTolerance(TemperatureTolerance.LOW_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.GLOWERING.output()))
                    .build()
    );
  }
  ...
  {
    bootstrap.register(ApicuriousSpecies.FURIOUS.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.FIENDISH.species())
                    .withSecond(ApicuriousSpecies.NETHER.species())
                    .withChance(0.3f)
                    .withOutput(ApicuriousSpecies.FURIOUS.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.VOLCANIC.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.FURIOUS.species())
                    .withSecond(ApicuriousSpecies.DEMONIC.species())
                    .withChance(0.2f)
                    .withOutput(ApicuriousSpecies.VOLCANIC.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.GLOWERING.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.FURIOUS.species())
                    .withSecond(ApicuriousSpecies.EXCITED.species())
                    .withChance(0.05f)
                    .withOutput(ApicuriousSpecies.GLOWERING.species())
                    .build()
    );
  }
  ...
  public static void outputsDefaults(BootstrapContext<OutputTable> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.VOLCANIC.output(), OutputTableDefaults.custom()
            .withPool(pool -> pool
            ...
            .withPool(pool -> pool
                    .when(new ChanceCondition(0.25f))
                    .withResult(result -> result.withResult(ItemRegistrar.BLAZING_COMB.get()))
            )
            .build()
    );
