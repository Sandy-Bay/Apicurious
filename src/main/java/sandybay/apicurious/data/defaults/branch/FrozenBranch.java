...
public class FrozenBranch
{
  public static void speciesDefaults(BootstrapContext<IAllele<?>> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.ICY.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.ICY.species(), "icy")
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.ICY.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.GLACIAL.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.GLACIAL.species(), "glacial")
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.GLACIAL.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.FRIGID.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.FRIGID.species(), "frigid")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.FRIGID))
                    .withProductionData(builder -> builder
                            .withFertility(Fertility.MAXIMUM_FERTILITY)
                            .withLifespan(Lifespan.SHORT)
                            .withPollinationRate(Pollination.SLOWEST)
                    ...
                    .withEnvironmentalData(builder -> builder
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.FRIGID.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.ABSOLUTE.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.ABSOLUTE.species(), "absolute")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.ABSOLUTE))
                    .withProductionData(builder -> builder
                            .withFertility(Fertility.MAXIMUM_FERTILITY)
                            .withLifespan(Lifespan.SHORT)
                            .withPollinationRate(Pollination.SLOWEST)
                    ...
                    .withEnvironmentalData(builder -> builder
                            .withTemperaturePreference(TemperaturePreference.ICY)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.ABSOLUTE.output()))
                    .build()
    );
  }
  ...
  {
    bootstrap.register(ApicuriousSpecies.ICY.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.MODEST.species())
                    .withSecond(ApicuriousSpecies.SINISTER.species())
                    .withChance(0.12f)
                    .withOutput(ApicuriousSpecies.ICY.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.GLACIAL.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.MODEST.species())
                    .withSecond(ApicuriousSpecies.SINISTER.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.GLACIAL.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.FRIGID.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.WINTRY.species())
                    .withSecond(ApicuriousSpecies.DILIGENT.species())
                    .withChance(0.1f)
                    .withOutput(ApicuriousSpecies.FRIGID.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.ABSOLUTE.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.FRIGID.species())
                    .withSecond(ApicuriousSpecies.OCEAN.species())
                    .withChance(0.1f)
                    .withOutput(ApicuriousSpecies.ABSOLUTE.species())
                    .build()
    );
  }
  ...
  public static void outputsDefaults(BootstrapContext<OutputTable> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.GLACIAL.output(), OutputTableDefaults.custom()
            .withPool(pool -> pool
    ...
    bootstrap.register(ApicuriousSpecies.ABSOLUTE.output(), OutputTableDefaults.custom()
            .withPool(pool -> pool
                    .when(new ChanceCondition(0.2f))
                    .withResult(result -> result.withResult(ItemRegistrar.FROZEN_COMB.get()))
            )
            .withPool(pool -> pool
                    ...
                    .withResult(result -> result.withResult(ItemRegistrar.GLACIAL_COMB.get()))
            ).build()
    );
  }
}
