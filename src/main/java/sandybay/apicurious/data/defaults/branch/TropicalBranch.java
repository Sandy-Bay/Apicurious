...
public class TropicalBranch
{
  public static void speciesDefaults(BootstrapContext<IAllele<?>> bootstrap)
  {
    ...
    bootstrap.register(ApicuriousSpecies.EXOTIC.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.EXOTIC.species(), "exotic")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.EXOTIC))
                    .withProductionData(builder -> builder
                    ...
                    .withEnvironmentalData(builder -> builder
                            ...
                            .withTemperaturePreference(TemperaturePreference.HOT)
                            .withTemperatureTolerance(TemperatureTolerance.LOWEST_TOLERANCE))
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.EXOTIC.output()))
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.EDENIC.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.EDENIC.species(), "edenic")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.EDENIC))
                    .withProductionData(builder -> builder
                    ...
                    .withOutputData(builder -> builder.withTable(ApicuriousSpecies.EDENIC.output()))
                    .build()
    );
  }
  ...
  {
    bootstrap.register(ApicuriousSpecies.EXOTIC.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.AUSTERE.species())
                    .withSecond(ApicuriousSpecies.TROPICAL.species())
                    .withChance(0.12f)
                    .withOutput(ApicuriousSpecies.EXOTIC.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.EDENIC.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.EXOTIC.species())
                    .withSecond(ApicuriousSpecies.TROPICAL.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.EDENIC.species())
                    .build()
    );
  }
