...
public class BoggyBranch
{
  ...
  {
    bootstrap.register(ApicuriousSpecies.DAMP.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.MARSHY.species())
                    .withSecond(ApicuriousSpecies.NOBLE.species())
                    .withChance(0.1f)
                    .withOutput(ApicuriousSpecies.DAMP.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.BOGGY.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.DAMP.species())
                    .withSecond(ApicuriousSpecies.MAJESTIC.species())
                    .withChance(0.1f)
                    .withOutput(ApicuriousSpecies.BOGGY.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.FUNGAL.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.BOGGY.species())
                    .withSecond(ApicuriousSpecies.IMPERIAL.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.FUNGAL.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.MIRY.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.MARSHY.species())
                    .withSecond(ApicuriousSpecies.DILIGENT.species())
                    .withChance(0.15f)
                    .withOutput(ApicuriousSpecies.MIRY.species())
                    .build()
    );
  }
