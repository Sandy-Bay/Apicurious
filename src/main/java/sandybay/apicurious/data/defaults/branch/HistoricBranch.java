...
public class HistoricBranch
{
  ...
  {
    bootstrap.register(ApicuriousSpecies.ANCIENT.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.ANCIENT.species(), "ancient")
    ...
    bootstrap.register(ApicuriousSpecies.PRIMEVAL.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.PRIMEVAL.species(), "primeval")
    ...
    bootstrap.register(ApicuriousSpecies.PREHISTORIC.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.PREHISTORIC.species(), "prehistoric")
                    .withVisualData(builder -> builder.withBeeColor(ApicuriousConstants.PREHISTORIC))
                    .withProductionData(builder -> builder
    ...
    bootstrap.register(ApicuriousSpecies.RELIC.species(),
            SpeciesDefaults.getSpeciesBuilder(bootstrap, ApicuriousSpecies.RELIC.species(), "relic")
  ...
  {
    bootstrap.register(ApicuriousSpecies.ANCIENT.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.NOBLE.species())
                    .withSecond(ApicuriousSpecies.DILIGENT.species())
                    .withChance(0.1f)
                    .withOutput(ApicuriousSpecies.ANCIENT.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.PRIMEVAL.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.ANCIENT.species())
                    .withSecond(ApicuriousSpecies.SECLUDED.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.PRIMEVAL.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.PREHISTORIC.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.PRIMEVAL.species())
                    .withSecond(ApicuriousSpecies.ANCIENT.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.PREHISTORIC.species())
                    .build()
    );
    bootstrap.register(ApicuriousSpecies.RELIC.mutation(),
            mutation(bootstrap)
                    .withFirst(ApicuriousSpecies.PREHISTORIC.species())
                    .withSecond(ApicuriousSpecies.IMPERIAL.species())
                    .withChance(0.08f)
                    .withOutput(ApicuriousSpecies.RELIC.species())
                    .build()
    );
  }
