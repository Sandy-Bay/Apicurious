...
public class MineralOutputs
{
  public static void defaults(BootstrapContext<OutputTable> bootstrap)
  {
    bootstrap.register(ApicuriousSpecies.LAZULI.output(), OutputTableDefaults.custom()
            .withPool(pool -> pool
            ...
            .withPool(pool -> pool
                    ...
                    .withResult(result -> result.withResult(ItemRegistrar.LAPIS_COMB.get()))
            ).build()
    );
  }
}
