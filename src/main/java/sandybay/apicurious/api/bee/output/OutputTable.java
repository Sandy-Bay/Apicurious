...
public record OutputTable(List<OutputPool> pools)
{
  ...
  public static final Codec<OutputTable> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(Codec.list(OutputPool.CODEC).fieldOf("pools").forGetter(OutputTable::pools)).apply(instance, OutputTable::new));
