...
public class MutationTypeRegistrar
{
  ...
  public static final DeferredHolder<MutationType, MutationType> BASE_MUTATION_TYPE = MUTATION_TYPES.register("mutation", () -> new MutationType(Mutation.CODEC));
  public static final DeferredHolder<MutationType, MutationType> CONDITONAL_MUTATION_TYPE = MUTATION_TYPES.register("conditional", () -> new MutationType(ConditionalMutation.CODEC));
