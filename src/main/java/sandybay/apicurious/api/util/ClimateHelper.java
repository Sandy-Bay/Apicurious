...
public class ClimateHelper {
  ...
  private TagKey<Biome> getTemperatureTagByBiome(Holder<Biome> biome) {
    ...
    if (!biome.isBound()) throw new IllegalArgumentException("Tried to get defaulted temperature tag from unbound biome! REPORT THIS!");
  ...
  private TagKey<Biome> getHumidityTagByBiome(Holder<Biome> biome) {
    TagKey<Biome> defaultedTag = null;
    if (!biome.isBound()) throw new IllegalArgumentException("Tried to get defaulted humidity tag from unbound biome! REPORT THIS!");
