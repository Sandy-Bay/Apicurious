                                       ...
                                       boolean requireLog, int logSearchRadius) implements FeatureConfiguration
{
  public static final Codec<HangingHiveConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
          BlockStateProvider.CODEC.fieldOf("hive").forGetter(HangingHiveConfiguration::hive),
          TagKey.codec(Registries.BLOCK).fieldOf("leaf_tag").forGetter(HangingHiveConfiguration::leafTag),
          TagKey.codec(Registries.BLOCK).fieldOf("log_tag").forGetter(HangingHiveConfiguration::logTag),
          Codec.BOOL.fieldOf("require_log").forGetter(HangingHiveConfiguration::requireLog),
          Codec.INT.optionalFieldOf("log_search_radius", 3).forGetter(HangingHiveConfiguration::logSearchRadius)
  ...
  public HangingHiveConfiguration(BlockStateProvider hive, TagKey<Block> leafTag, TagKey<Block> logTag, boolean requireLog)
  {
