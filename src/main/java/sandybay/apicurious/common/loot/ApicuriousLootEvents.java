    ...
    if ("minecraft".equals(name.getNamespace()))
    {
      switch (name.getPath())
      {
        ...
        case "chests/abandoned_mineshaft", "chests/simple_dungeon":
          injectInto(event, "pool1", addBee(ItemRegistrar.DRONE.item(), ApicuriousSpecies.STEADFAST.species(), 25));
          break;
        case "chests/pillager_outpost":
          injectInto(event, "pool3", addBee(ItemRegistrar.DRONE.item(), ApicuriousSpecies.STEADFAST.species(), 25));
          break;
      }
    }
  }
