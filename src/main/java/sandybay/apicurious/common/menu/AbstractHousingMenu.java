...
public abstract class AbstractHousingMenu extends AbstractContainerMenu
{
  ...
  private void addApiarySlots(ConfigurableItemStacksResourceHandler inventory)
  {
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 0, baseInputCoords.getFirst(), baseInputCoords.getSecond()));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 1, baseInputCoords.getFirst(), baseInputCoords.getSecond() + inputOffset));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 2, baseFrameCoords.getFirst(), baseFrameCoords.getSecond()));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 3, baseFrameCoords.getFirst(), baseFrameCoords.getSecond() + frameOffset));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 4, baseFrameCoords.getFirst(), baseFrameCoords.getSecond() + frameOffset * 2));

    // Because of the wierd offset of these, do the coordination positioning manually.
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 5, 116, 52));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 6, 94, 39));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 7, 116, 25));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 8, 136, 39));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 9, 136, 65));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 10, 116, 78));
    this.addSlot(new ResourceHandlerSlot(inventory, inventory::set, 11, 94, 65));
  }
