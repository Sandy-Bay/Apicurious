...
public class ApiaryMenu extends AbstractHousingMenu
{
  ...
  {
    super(MenuRegistrar.APIARY.get(), containerId, playerInventory);
  ...
  {
    super(MenuRegistrar.APIARY.get(), containerId, playerInventory, access, apiary.getInventory(), apiary.getErrorList());
    this.player = playerInventory.player;
    this.apiary = apiary;
  ...
  public void removed(Player player)
  {
    ...
    {
      apiary.removeViewer(serverPlayer);
    }
  }
  ...
  {
    return AbstractContainerMenu.stillValid(getAccess(), player, BlockRegistrar.APIARY.asBlock());
  }
}
