...
{
  public static final MapCodec<DropItemTinter> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance
          .group(Codec.BOOL.optionalFieldOf("isHighlight", false).forGetter(DropItemTinter::isHighlight))
          .apply(instance, DropItemTinter::new)
  );
